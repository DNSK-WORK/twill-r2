...
/**
 * Safe media deletion: wraps Twill's afterDelete in try/catch so that R2 listing
...
class MediaRepository extends BaseMediaRepository
{
    public function afterDelete($object): void
    {
        ...
        try {
            ...
            Log::warning('twill-r2: media delete from disk failed', ['uuid' => $storageId, 'error' => $e->getMessage()]);
        }
